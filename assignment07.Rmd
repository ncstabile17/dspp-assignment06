...
This model specification will use K-Nearest Neighbors as the algorithm. For KNN all predictor variables must be continuous and all must be normalized as one of the preprocessing steps. The *K* hyperparameter will be set using grid search for a range of potential values.
